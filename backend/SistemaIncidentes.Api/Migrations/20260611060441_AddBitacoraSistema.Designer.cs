...
namespace SistemaIncidentes.Api.Migrations
{
    ...
    [Migration("20260611060441_AddBitacoraSistema")]
    partial class AddBitacoraSistema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaIncidentes.Api.Models.AdjuntoTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("adjuntos_ticket", (string)null);
                });
            ...
            modelBuilder.Entity("SistemaIncidentes.Api.Models.ConfiguracionSla", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("IntervaloRevisionMinutos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                        .HasColumnName("intervalo_revision_minutos");

                    b.Property<int>("PorcentajeProximoVencimiento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(25)
                    ...
                    b.ToTable("configuracion_sla", (string)null);
                });
            ...
            modelBuilder.Entity("SistemaIncidentes.Api.Models.MatrizPrioridad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("Impacto", "Urgencia")
                        .IsUnique();

                    b.ToTable("matriz_prioridad", (string)null);
                });

            modelBuilder.Entity("SistemaIncidentes.Api.Models.NotificacionSla", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("TicketId", "TipoAlerta", "DestinatarioCorreo")
                        .IsUnique();

                    b.ToTable("notificaciones_sla", (string)null);
                });
            ...
            modelBuilder.Entity("SistemaIncidentes.Api.Models.Ticket", b =>
                {
                    ...
                    b.Property<string>("MotivoEscalamiento")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
            ...
            modelBuilder.Entity("SistemaIncidentes.Api.Models.Usuario", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaExpiracionTokenResetPassword")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("SistemaIncidentes.Api.Models.ConfiguracionSla", b =>
                {
                    b.HasOne("SistemaIncidentes.Api.Models.Usuario", "UsuarioActualizacion")
                        .WithMany()
